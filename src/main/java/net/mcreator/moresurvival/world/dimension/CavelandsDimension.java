...
package net.mcreator.moresurvival.world.dimension;
...
import net.mcreator.moresurvival.item.CavelandsItem;
import net.mcreator.moresurvival.MoreSurvivalModElements;
...
@MoreSurvivalModElements.ModElement.Tag
public class CavelandsDimension extends MoreSurvivalModElements.ModElement {
	@ObjectHolder("more_survival:invertedlands_portal")
	public static final CustomPortalBlock portal = null;
	public CavelandsDimension(MoreSurvivalModElements instance) {
		super(instance, 22);
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(Blocks.OAK_LEAVES.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		DimensionRenderInfo customEffect = new DimensionRenderInfo(Float.NaN, true, DimensionRenderInfo.FogType.NONE, false, false) {
			...
			public Vector3d func_230494_a_(Vector3d color, float sunHeight) {
				return new Vector3d(0, 0.56862745098, 1);
			}
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("more_survival:invertedlands"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("invertedlands_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("invertedlands_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())),
					0, 1).setRegistryName("invertedlands_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new CavelandsItem().setRegistryName("invertedlands"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("invertedlands_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("more_survival:invertedlands"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("more_survival:invertedlands")));
				} else {
					entity.func_242279_ag();
